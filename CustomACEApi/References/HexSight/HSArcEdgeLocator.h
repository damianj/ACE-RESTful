...
// ****************************************************************************
//
// File.........: HSArcEdgeLocator.h
//
// Description..: This file contains the definition of the HSArcEdgeLocator class.
//
// Platforms....: All
//
// ****************************************************************************
...
#ifndef __HSARCEDGELOCATOR_H__
#define __HSARCEDGELOCATOR_H__
...
// HSARCEDGELOCATOR_COMPILATION_DLL <Reserved>

#ifdef WIN32
	#ifdef HSARCEDGELOCATOR_COMPILATION_DLL
		#define HSARCEDGELOCATOR_EXPORT __declspec(dllexport)
	#else
		#ifdef HSSTATICLIBRARY
			#define HSARCEDGELOCATOR_EXPORT
		#else
			#define HSARCEDGELOCATOR_EXPORT __declspec(dllimport)
		#endif
	#endif
#else
	#define HSARCEDGELOCATOR_EXPORT
...
class HSARCEDGELOCATOR_EXPORT HSArcEdgeLocator
{
public:
...
public:
	...
	// UTILITY
					...
					HSArcEdgeLocator( void );
					HSArcEdgeLocator( const HSArcEdgeLocator & Object );
    virtual		   ~HSArcEdgeLocator( void );

					HSArcEdgeLocator & operator=( const HSArcEdgeLocator & Object );
...
public:
	...
	float			GetEdgeRadius( int EdgeIndex ) const;

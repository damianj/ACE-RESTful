...
// ****************************************************************************
//
//                Copyright (C) 2004 Adept Technology Inc.
//                All rights reserved
//
// ****************************************************************************
//
...
#ifndef __HSMODELCOLOR_H__
#define __HSMODELCOLOR_H__
...
class HSMODEL_EXPORT HSModelColor
{
public:
...
public:
	...
	// UTILITY
					HSModelColor( );
					HSModelColor( const HSModel & Object );
					HSModelColor( const HSModelColor & Object );
	virtual		   ~HSModelColor( void );

					HSModelColor & operator=( const HSModelColor & Object );
